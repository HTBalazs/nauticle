...
std::string const pmMath_test::list_of_functions[80] = {"abs", "acos", "acot", "and", "asin", "atan", "cos", "cosh", "cot", "coth", "dem_l", "dem_a", "div", "elem", "exp", "floor", "fmax", "fmean", "fmin", "fsum", "grad", "gt", "if", "log", "lt", "magnitude", "max", "min", "mod", "not", "or", "rand", "sgn", "sin", "sinh", "sph_D00", "sph_D01", "sph_D10", "sph_D11", "sph_D20", "sph_G00", "sph_G01", "sph_G10", "sph_G11", "sph_G20", "sph_L00", "sph_L10", "sph_S00", "sph_X00", "vm", "sqrt", "tan", "tanh", "trace", "transpose", "trunc", "xor", "identity", "neighbours", "simulation", "workspace", "solver", "variables", "constants", "fields", "particle_system", "parameter_space", "domain", "cell_size", "grid", "equations", "nbody", "cross", "inverse", "determinant", "eq", "euler", "predictor", "corrector", "condition"};
