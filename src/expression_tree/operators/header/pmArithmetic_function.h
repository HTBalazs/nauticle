	...
	*/
	...
	pmTensor pmArithmetic_function<ARI_TYPE,S>::evaluate(int const& i, size_t const& level/*=0*/) const {
		switch(ARI_TYPE) {
			...
			case GT : return pmTensor{(double)((tensor_cast<double>(this->operand[0]->evaluate(i, level)) > tensor_cast<double>(this->operand[1]->evaluate(i, level))))};
			case GTE : return pmTensor{(double)((tensor_cast<double>(this->operand[0]->evaluate(i, level)) >= tensor_cast<double>(this->operand[1]->evaluate(i, level))))};
			case EQUAL : return pmTensor{(double)((tensor_cast<double>(this->operand[0]->evaluate(i, level)) == tensor_cast<double>(this->operand[1]->evaluate(i, level))))};
			case NOTEQUAL : return !pmTensor{(double)((tensor_cast<double>(this->operand[0]->evaluate(i, level)) == tensor_cast<double>(this->operand[1]->evaluate(i, level))))};
			...
			case LT : return pmTensor{(double)((tensor_cast<double>(this->operand[0]->evaluate(i, level)) < tensor_cast<double>(this->operand[1]->evaluate(i, level))))};
			case LTE : return pmTensor{(double)((tensor_cast<double>(this->operand[0]->evaluate(i, level)) <= tensor_cast<double>(this->operand[1]->evaluate(i, level))))};
			...
			case OR : return pmTensor{(double)((tensor_cast<double>(this->operand[0]->evaluate(i, level)) || tensor_cast<double>(this->operand[1]->evaluate(i, level))))};
			...
			case XOR : return pmTensor{(double)((tensor_cast<double>(this->operand[0]->evaluate(i, level)) != tensor_cast<double>(this->operand[1]->evaluate(i, level))))};
