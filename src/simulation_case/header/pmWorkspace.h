...
namespace Nauticle {
	...
	*/
	...
	public:
		...
		void add_field(std::string const& name, pmTensor const& value=pmTensor{0}, bool const& sym=true);
		void add_field(std::string const& name, std::vector<pmTensor> const& values, bool const& sym=true);
