...
namespace Nauticle {
	...
	public:
		...
		void update(std::shared_ptr<pmParticle_system> psys, std::shared_ptr<pmSymbol> particle_force, std::shared_ptr<pmSymbol> particle_velocity, std::shared_ptr<pmSymbol> particle_mass, double const& time_step_size);
