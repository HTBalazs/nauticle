...
pmWorkspace::pmWorkspace() {
	...
	this->add_constant("Wp01110", pmTensor{1,1,12}, true);
	this->add_constant("Wp01120", pmTensor{1,1,13}, true);
	this->add_constant("Wp01130", pmTensor{1,1,14}, true);
	this->add_constant("Wp11110", pmTensor{1,1,15}, true);
	this->add_constant("Wp11120", pmTensor{1,1,16}, true);
	this->add_constant("Wp11130", pmTensor{1,1,17}, true);
