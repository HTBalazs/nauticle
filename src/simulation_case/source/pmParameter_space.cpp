...
/// Constructor.
/////////////////////////////////////////////////////////////////////////////////////////
pmParameter_space::pmParameter::pmParameter(std::string const& n, std::shared_ptr<pmExpression> const& expr) {
	name = n;
	value = expr;
}
...
/////////////////////////////////////////////////////////////////////////////////////////
void pmParameter_space::add_parameter(std::string const& n, std::shared_ptr<pmExpression> const& expr) {
	...
	parameters.push_back(std::make_shared<pmParameter>(n,expr));
}
